...
CREATE TABLE `appraisal` (
  ...
  `school_email_id` varchar(45) NOT NULL,
  `school_phone_no` int(11) NOT NULL,
  `assigned_date` datetime NOT NULL,
  PRIMARY KEY (`employee_id`,`school_id`),
  KEY `school_id_idx` (`school_id`),
  CONSTRAINT `employee_id` FOREIGN KEY (`employee_id`) REFERENCES `supervisor_details` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE
